...
3. `scripts/set-lynx-version.sh`로 Podfile 갱신 (Lynx/LynxService/XElement = 대상 버전,
   PrimJS = 같은 major.minor 중 최신) 후 PR 생성.
...
scripts/set-lynx-version.sh 3.9.0             # Podfile 버전 일괄 갱신
